...
Here is a concept of a **station key**:
   ...
   1. Here is the concept of the <Blocks> section:
      ```
      <Block>:<Block>:<Block>:<Block>:<Block>:<Block>:<Block>:<Block>:<Block>
      ```
         - Here is the concept of a *Block*:
          ```
          <name>;<posX>~<posY>[2];<r>[3];<paintID>(;<iID>;<aID>)
          ```
   2. Here is the concept of the <___ IDs> sections:
      ```
      <Definition>
      <Definition>
      <Definition>
      <Definition>
      ```
         - Here is the concept of a *Definition* (Paint)
           ```
           <paintID>=<Paint[7]>
           ```
         - Here is the concept of a *Definition* (Image)
           ```
           <iID>=<url>;<PPM>
           ```
           (Example of url: `https://i.imgur.com/dm4j04V.png`)
           PPM is Pixel Per ingame Meter, an ingame meter is a block
         - Here is the concept of *Definition* (Animation)
           ```
           <aID>=<interval>;[(image:<iID>/paint:<Paint>[7],trigger:<milliseconds>)]
           ```
**Note: Keep the newlines**
